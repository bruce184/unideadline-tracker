...
begin
  ...
  values
    ...
    ('aaaaaaaa-0005-4000-8000-000000000005', demo_user_id, db_course_id, 'ERD draft submission', now() - interval '2 days', 'Not Started', 'High', 'Submit the first ERD draft for feedback.', 'https://example.com/db/erd-draft'),
    ...
    ('aaaaaaaa-0015-4000-8000-000000000015', demo_user_id, ai_course_id, 'Ethics reflection', now() - interval '1 day', 'Not Started', 'Medium', 'Write a short reflection on responsible AI use.', null),
